...
render_file_name = 'me_small_out_tracked_orb.0001.avi'
...
video_out_tracked_orb = cv2.VideoWriter(render_folder + render_file_name, video_out_codec, video_fps, (540, 960))
