...
def draw_info(img, trajectory, traj_proj, framenum, color):
    ...
    if framenum > check_frame1:
        ...
        cv2.putText(img, 'Corner 1: ' + str(trajectory[check_frame1][0]) + ':' + str(trajectory[check_frame1][1]),
                    (15, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.35, color, 1, cv2.LINE_AA)
    if framenum > check_frame2:
        ...
        cv2.putText(img, 'Corner 2: ' + str(trajectory[check_frame2][0]) + ':' + str(trajectory[check_frame2][1]),
                    (15, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.35, color, 1, cv2.LINE_AA)
    if framenum > check_frame3:
        ...
        cv2.putText(img, 'Corner 3: ' + str(trajectory[check_frame3][0]) + ':' + str(trajectory[check_frame3][1]),
                    (15, 130), cv2.FONT_HERSHEY_SIMPLEX, 0.35, color, 1, cv2.LINE_AA)
    if framenum > check_frame4:
        ...
        cv2.putText(img, 'Corner 4: ' + str(trajectory[check_frame4][0]) + ':' + str(trajectory[check_frame4][1]),
                    (15, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.35, color, 1, cv2.LINE_AA)
    if framenum > check_frame5:
        ...
        cv2.putText(img, 'Middle: ' + str(trajectory[check_frame5][0]) + ':' + str(trajectory[check_frame5][1]),
                    (15, 170), cv2.FONT_HERSHEY_SIMPLEX, 0.35, color, 1, cv2.LINE_AA)
